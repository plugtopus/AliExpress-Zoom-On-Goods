...
const summary = chrome.i18n.getMessage('desc');
...
const share_tw="http://twitter.com/share?";
...
const share_vk="https://vk.com/share.php?s=100&url=${url}&title=${title}&summary=${summary}";
